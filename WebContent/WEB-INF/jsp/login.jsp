...
<BODY>
<FORM id=form1 name=form1 action="<%=basePath%>user/login.action" method="post" target="_parent">
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px" width=150>
                	<INPUT id="user_code" style="WIDTH: 130px" name="user_code" onblur="checkCode()" value="${user_code}">
                </TD>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px">
                	<INPUT id="user_password" style="WIDTH: 130px" type="password" name="user_password" onblur="checkPwd()" value="${user_password}">
                </TD>
                <TD style="HEIGHT: 28px">
              ...
              <TR>
                ...
                <TD><INPUT id=btn 
                  ...
                  type=image src="<%=basePath%>images/login_button.gif" name=btn> 
