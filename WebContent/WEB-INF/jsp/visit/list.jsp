...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="<%=basePath%>visit/findByPage.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<td>选择时间：</td>
													<td>
														<INPUT class=textbox id="beginDate" style="WIDTH: 180px" name="beginDate" readonly="readonly" value="<fmt:formatDate value="${beginDate}" pattern="yyyy-MM-dd"/>">
														至
														<INPUT class=textbox id="endDate" style="WIDTH: 180px" name="endDate" readonly="readonly" value="<fmt:formatDate value="${endDate}" pattern="yyyy-MM-dd"/>">
													<td>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<td><fmt:formatDate value="${visit.visit_nexttime}" pattern="yyyy-MM-dd"/></td>
												</TR>
