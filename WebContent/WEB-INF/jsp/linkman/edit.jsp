...
<BODY>
	<FORM id=form1 name=form1 action="<%=basePath%>linkman/edit.action" method="post">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<tr>
								...
								<td>联系人QQ：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="lkm_qq" value="${linkman.lkm_qq}">
								</td>
							</tr>
							...
							<tr>
								...
								<td>联系人备注：</td>
								<td>
									<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="lkm_memo" value="${linkman.lkm_memo}">
								</td>
							</tr>
							<tr>
								<td rowspan=2>
