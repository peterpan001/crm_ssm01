...
<BODY>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
			<TBODY>
			<tr>
			   <TD width=15 background="<%=basePath%>images/new_022.jpg">
			   <IMG	src="<%=basePath%>images/new_022.jpg" border=0>
			   </TD>
					<TD align="center" bgColor=#ffffff>
						<table width="100%" height=300 border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td align="center"><img src="<%=basePath%>images/welcome.gif"
									width="145" height="46" /></td>
							</tr>
						</table>
					</td>
					<TD width=15 background="<%=basePath%>images/new_023.jpg">
				<IMG src="<%=basePath%>images/new_023.jpg" border=0>
				</TD>
			</tr>
			</TBODY>
		</table>
